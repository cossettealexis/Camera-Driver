...
function SendNotify(notifyText, tParams, bindingID)
    print("SendNotify bindingID " ..tostring(bindingID))
    print("SendNotify notifyText " ..notifyText)
    for key, value in pairs(tParams) do
        print("SendNotify tParams " .. tostring(key) .. " = " .. tostring(value))
    end
