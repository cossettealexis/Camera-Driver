...
function ReceivedFromProxy(idBinding, strCommand, tParams)
    ...
    if Properties["Contract"] == "Enable" then 
        ...
        -- end)
        print("tParams ", C4:JsonEncode(tParams))
...
function RFP.ACTIVATE_SCENE(idBinding, strCommand, tParams, args) 
    print("call RFP.ACTIVATE_SCENE", idBinding, strCommand, C4:JsonEncode(tParams), C4:JsonEncode(args))
end
function RFP.PUSH_SCENE(idBinding, strCommand, tParams, args) 
    print("call RFP.PUSH_SCENE", idBinding, strCommand, C4:JsonEncode(tParams), C4:JsonEncode(args))
end
